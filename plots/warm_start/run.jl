...
global model = DRO.build_model(scen_tree, cost, dynamics, rms, DRO.DYNAMICS_IN_L_SOLVER)

global x = [1., 1.]

# Log Vanilla with warm start
for t = 1:T
  if t === 1
    DRO.solve_model(
      model, 
